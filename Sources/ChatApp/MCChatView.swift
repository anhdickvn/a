    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Button("Disconnect", role: .destructive) {
                // Chat hiện tại đã được archive theo từng tin ở historyStore.
                // Khi người dùng chủ động Disconnect, chỉ xóa phiên chat trên màn hình;
                // Logs vẫn giữ nguyên toàn bộ lịch sử theo ngày.
                client.disconnect()
...
private struct HoldButton: View {
    ...
    var body: some View {
        Text(title)
            ...
            // Một gesture duy nhất cho cả tap và hold. Cách cũ dùng Tap + LongPress +
            // Drag đồng thời nên iOS có thể tranh touch, khiến WASD/JUMP không nhận.
            .gesture(
