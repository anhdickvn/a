...
final class MCClient: ObservableObject {
    ...
    /// Heartbeat movement theo nhịp client vanilla: 20 ticks/giây. Khi không đổi
    /// vị trí/góc nhìn, packet C03 cơ sở chính là Player (0x0C), chỉ chứa On Ground.
    ...
    private func handlePlayPacket(id: Int32, body: Data) {
        ...
        case 0x1A: // Disconnect (play)
            ...
            appendLog(.error, "Bị ngắt kết nối: \(readableReason)")
