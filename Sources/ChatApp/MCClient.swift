...
final class MCClient: ObservableObject {
    ...
    func movePlayer(dx: Double, dz: Double) {
        ...
        // For active WASD movement, send the combined Position+Look packet so the
        // server receives both authoritative coordinates and the current rotation.
        // Idle heartbeat continues to use plain Player Position. This is a valid
        // protocol-340 serverbound packet and better matches a real client when
