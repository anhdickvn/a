...
final class MCClient: ObservableObject {
    ...
    private func handlePlayPacket(id: Int32, body: Data) {
        ...
        case 0x1A: // Disconnect (play)
            ...
            reconnectWorkItem?.cancel()
            reconnectWorkItem = nil
            // Server chủ động disconnect: xóa ngay chat của phiên hiện tại.
            // Debug trace vẫn giữ nguyên để người dùng có thể bật Debug trong Settings
            // và xem/copy nguyên nhân sau khi bị kick.
            clearCurrentChatMessagesPreservingDebug()
            state = .disconnected
    ...
    func jumpPlayer() {
        ...
        movementLastSentX = playerX
        movementLastSentZ = playerZ
        sendPlayerPositionAndLook(onGround: false)
        ...
        let work = DispatchWorkItem { [weak self] in
            ...
            if elapsed >= 0.55 {
                ...
                self.sendPlayerPositionAndLook(onGround: true)
            ...
            self.sendPlayerPositionAndLook(onGround: false)
    ...
    private func jumpPlayerTick(generation: Int, startY: Double, startTime: Date) {
        ...
        if elapsed >= 0.55 {
            ...
            isOnGround = true
            sendPlayerPositionAndLook(onGround: true)
