...
final class MCClient: ObservableObject {
    ...
    func movePlayer(dx: Double, dz: Double) {
        ...
        // ~3.8 blocks/s at 20 TPS, close to a normal walk speed.
        let maxStep = 0.19
        ...
        // Protocol 340: serverbound Player Position = 0x0D.
        // Do NOT use 0x0E for a normal movement step; that packet is only needed
        // when the look rotation actually changes.
